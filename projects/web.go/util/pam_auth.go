...
// PamAuthenticate - authenticates a user based on local PAM based
// authentication
func PamAuthenticate(username, password string) int {
...
/*
  sudo setcap 'cap_dac_read_search=+ep' app.elf
*/
